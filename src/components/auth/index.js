    ...
    <PreventAuthRoute>
      <div className='auth_container'>
        ...
        <form className='mt-3' onSubmit={formik.handleSubmit}>
          ...
          <div className='form-group'>
            <TextField style={{ width: '100%' }} name='password' label='Enter your password' type='password' variant='outlined' {...formik.getFieldProps('password')} {...errorHelper(formik, 'password')} />
          </div>
